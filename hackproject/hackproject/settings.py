...
ALLOWED_HOSTS = ['*']  # Adjust for production (e.g., ['yourdomain.com'])
...
ROOT_URLCONF = 'hackproject.urls'  # Replace with your project name
...
WSGI_APPLICATION = 'hackproject.wsgi.application'  # Replace with your project name
